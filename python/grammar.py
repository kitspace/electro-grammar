...
# Code follows:
var.registers(['filter', 'resistance', 'capacitance', 'type', 'flat', 'nuller', 'flatten', 'toImperial', 'id'])
@Js
...
def PyJsHoisted_flat_(arr, res, this, arguments, var=var):
    var = Scope({'res':res, 'this':this, 'arguments':arguments, 'arr':arr}, var)
    var.registers(['cur', 'res', 'len', 'i', 'arr'])
    var.put('i', Js(0.0))
...
def PyJsHoisted_resistance_(d, i, reject, this, arguments, var=var):
    var = Scope({'d':d, 'reject':reject, 'arguments':arguments, 'this':this, 'i':i}, var)
    var.registers(['quantity', 'i', 'd', 'reject', 'ohm', 'metricPrefix', 'integral', 'fractional'])
...
def PyJsHoisted_capacitance_(d, this, arguments, var=var):
    var = Scope({'d':d, 'this':this, 'arguments':arguments}, var)
    var.registers(['d', 'metricPrefix', 'quantity', 'farad'])
...
def PyJsHoisted_flatten_(arr, this, arguments, var=var):
    var = Scope({'this':this, 'arguments':arguments, 'arr':arr}, var)
    var.registers(['arr'])
...
var.put('alias_59', PyJs_anonymous_8_)
@Js
...
var.put('alias_41', PyJs_anonymous_9_)
@Js
...
var.put('alias_9', PyJs_anonymous_10_)
@Js
...
var.put('alias_36', PyJs_anonymous_11_)
...
var.put('alias_32', PyJs_anonymous_12_)
@Js
def PyJs_anonymous_13_(d, this, arguments, var=var):
    var = Scope({'d':d, 'this':this, 'arguments':arguments}, var)
    var.registers(['d'])
    if var.get('d').get('0'):
...
var.put('alias_1', PyJs_anonymous_13_)
@Js
...
var.put('alias_4', PyJs_anonymous_14_)
@Js
...
var.put('alias_31', PyJs_anonymous_16_)
@Js
...
var.put('alias_54', PyJs_anonymous_17_)
...
var.put('alias_38', PyJs_anonymous_18_)
@Js
...
var.put('alias_5', PyJs_anonymous_19_)
@Js
...
var.put('alias_65', PyJs_anonymous_20_)
@Js
...
var.put('alias_55', PyJs_anonymous_21_)
@Js
...
var.put('alias_23', PyJs_anonymous_22_)
@Js
...
var.put('alias_53', PyJs_anonymous_23_)
@Js
...
var.put('alias_12', PyJs_anonymous_24_)
@Js
def PyJs_anonymous_25_(d, this, arguments, var=var):
    var = Scope({'d':d, 'this':this, 'arguments':arguments}, var)
    var.registers(['d'])
    PyJs_Object_26_ = Js({'characteristic':var.get('d').get('0').get('0')})
    return PyJs_Object_26_
PyJs_anonymous_25_._set_name('anonymous')
var.put('alias_18', PyJs_anonymous_25_)
...
var.put('alias_11', PyJs_anonymous_27_)
@Js
...
var.put('alias_10', PyJs_anonymous_28_)
@Js
...
var.put('alias_71', PyJs_anonymous_29_)
@Js
...
var.put('alias_20', PyJs_anonymous_30_)
@Js
...
var.put('alias_37', PyJs_anonymous_31_)
@Js
def PyJs_anonymous_32_(d, this, arguments, var=var):
    var = Scope({'d':d, 'this':this, 'arguments':arguments}, var)
    var.registers(['d'])
    PyJs_Object_33_ = Js({'tolerance':var.get('d').get('1')})
    return PyJs_Object_33_
PyJs_anonymous_32_._set_name('anonymous')
var.put('alias_42', PyJs_anonymous_32_)
@Js
...
var.put('alias_21', PyJs_anonymous_34_)
@Js
...
var.put('alias_6', PyJs_anonymous_35_)
@Js
def PyJs_anonymous_36_(d, this, arguments, var=var):
    var = Scope({'d':d, 'this':this, 'arguments':arguments}, var)
    var.registers(['d'])
    PyJs_Object_37_ = Js({'size':var.get('filter')(var.get('flatten')(var.get('d'))).get('0')})
    return PyJs_Object_37_
PyJs_anonymous_36_._set_name('anonymous')
var.put('alias_8', PyJs_anonymous_36_)
...
var.put('alias_77', PyJs_anonymous_38_)
@Js
...
var.put('alias_24', PyJs_anonymous_39_)
@Js
def PyJs_anonymous_40_(d, this, arguments, var=var):
    ...
    var.put('quantity', var.get('d').get('0'))
    var.put('metricPrefix', var.get('d').get('2'))
    PyJs_Object_41_ = Js({'power_rating':var.get('parseFloat')((var.get('quantity')+(var.get('metricPrefix') or Js(''))))})
    return PyJs_Object_41_
PyJs_anonymous_40_._set_name('anonymous')
var.put('alias_47', PyJs_anonymous_40_)
@Js
...
var.put('alias_29', PyJs_anonymous_42_)
@Js
...
var.put('alias_19', PyJs_anonymous_43_)
@Js
...
var.put('alias_64', PyJs_anonymous_44_)
@Js
...
var.put('alias_62', PyJs_anonymous_45_)
@Js
...
var.put('alias_69', PyJs_anonymous_46_)
@Js
...
var.put('alias_72', PyJs_anonymous_47_)
@Js
def PyJs_anonymous_48_(d, this, arguments, var=var):
    var = Scope({'d':d, 'this':this, 'arguments':arguments}, var)
    var.registers(['d'])
...
var.put('alias_3', PyJs_anonymous_48_)
...
var.put('alias_39', PyJs_anonymous_49_)
@Js
...
var.put('alias_63', PyJs_anonymous_50_)
@Js
...
var.put('alias_30', PyJs_anonymous_51_)
...
var.put('alias_58', PyJs_anonymous_52_)
@Js
...
var.put('alias_22', PyJs_anonymous_53_)
@Js
...
var.put('alias_74', PyJs_anonymous_55_)
...
var.put('alias_61', PyJs_anonymous_56_)
...
var.put('alias_66', PyJs_anonymous_57_)
...
var.put('alias_26', PyJs_anonymous_58_)
@Js
...
var.put('alias_57', PyJs_anonymous_59_)
@Js
...
var.put('alias_56', PyJs_anonymous_60_)
@Js
...
var.put('alias_2', PyJs_anonymous_61_)
@Js
...
var.put('alias_28', PyJs_anonymous_62_)
@Js
...
var.put('alias_73', PyJs_anonymous_63_)
@Js
...
var.put('alias_60', PyJs_anonymous_64_)
@Js
...
var.put('alias_27', PyJs_anonymous_65_)
@Js
...
var.put('alias_34', PyJs_anonymous_66_)
@Js
...
var.put('alias_25', PyJs_anonymous_67_)
@Js
...
var.put('alias_67', PyJs_anonymous_68_)
@Js
...
var.put('alias_33', PyJs_anonymous_69_)
@Js
...
var.put('alias_7', PyJs_anonymous_70_)
@Js
...
var.put('alias_35', PyJs_anonymous_71_)
@Js
def PyJs_anonymous_72_(d, this, arguments, var=var):
    var = Scope({'d':d, 'this':this, 'arguments':arguments}, var)
    var.registers(['d'])
    PyJs_Object_73_ = Js({'voltage_rating':var.get('d').get('0')})
    return PyJs_Object_73_
PyJs_anonymous_72_._set_name('anonymous')
var.put('alias_17', PyJs_anonymous_72_)
@Js
...
var.put('alias_75', PyJs_anonymous_74_)
@Js
...
var.put('alias_40', PyJs_anonymous_75_)
...
var.put('alias_76', PyJs_anonymous_76_)
@Js
...
var.put('alias_70', PyJs_anonymous_77_)
@Js
def PyJs_anonymous_78_(d, this, arguments, var=var):
    var = Scope({'d':d, 'this':this, 'arguments':arguments}, var)
    var.registers(['d'])
    PyJs_Object_79_ = Js({'color':var.get('d').get('0')})
    return PyJs_Object_79_
PyJs_anonymous_78_._set_name('anonymous')
var.put('alias_52', PyJs_anonymous_78_)
pass
