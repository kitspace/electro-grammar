...
# Code follows:
var.registers(['id', 'capacitance', 'toImperial', 'type', 'filter', 'flat', 'flatten', 'resistance', 'nuller'])
@Js
...
def PyJsHoisted_capacitance_(d, this, arguments, var=var):
    ...
    var.registers(['quantity', 'farad', 'metricPrefix', 'd'])
...
def PyJsHoisted_resistance_(d, i, reject, this, arguments, var=var):
    var = Scope({'this':this, 'arguments':arguments, 'reject':reject, 'd':d, 'i':i}, var)
    var.registers(['fractional', 'reject', 'i', 'quantity', 'integral', 'metricPrefix', 'd', 'ohm'])
...
def PyJsHoisted_flat_(arr, res, this, arguments, var=var):
    var = Scope({'this':this, 'res':res, 'arr':arr, 'arguments':arguments}, var)
    var.registers(['len', 'res', 'cur', 'arr', 'i'])
    var.put('i', Js(0.0))
...
def PyJs_anonymous_9_(d, this, arguments, var=var):
    ...
    var.put('quantity', var.get('d').get('0'))
    var.put('metricPrefix', var.get('d').get('2'))
    PyJs_Object_10_ = Js({'power_rating':var.get('parseFloat')((var.get('quantity')+(var.get('metricPrefix') or Js(''))))})
    return PyJs_Object_10_
PyJs_anonymous_9_._set_name('anonymous')
var.put('alias_47', PyJs_anonymous_9_)
@Js
...
var.put('alias_71', PyJs_anonymous_11_)
@Js
...
var.put('alias_54', PyJs_anonymous_12_)
@Js
...
var.put('alias_67', PyJs_anonymous_13_)
var.put('alias_45', var.get('nuller'))
@Js
def PyJs_anonymous_14_(d, this, arguments, var=var):
    var = Scope({'this':this, 'd':d, 'arguments':arguments}, var)
    var.registers(['d'])
    PyJs_Object_15_ = Js({'size':var.get('filter')(var.get('flatten')(var.get('d'))).callprop('join', Js(''))})
    return PyJs_Object_15_
PyJs_anonymous_14_._set_name('anonymous')
var.put('alias_8', PyJs_anonymous_14_)
@Js
...
var.put('alias_41', PyJs_anonymous_16_)
@Js
...
var.put('alias_63', PyJs_anonymous_17_)
@Js
...
var.put('alias_20', PyJs_anonymous_18_)
@Js
...
var.put('alias_32', PyJs_anonymous_19_)
@Js
...
var.put('alias_53', PyJs_anonymous_20_)
@Js
...
var.put('alias_72', PyJs_anonymous_21_)
@Js
...
var.put('alias_28', PyJs_anonymous_25_)
@Js
...
var.put('alias_38', PyJs_anonymous_28_)
@Js
...
var.put('alias_76', PyJs_anonymous_29_)
@Js
...
var.put('alias_10', PyJs_anonymous_30_)
@Js
...
var.put('alias_40', PyJs_anonymous_31_)
@Js
...
var.put('alias_11', PyJs_anonymous_33_)
@Js
...
var.put('alias_0', PyJs_anonymous_34_)
@Js
...
var.put('alias_61', PyJs_anonymous_35_)
@Js
...
var.put('alias_1', PyJs_anonymous_36_)
@Js
...
var.put('alias_60', PyJs_anonymous_37_)
@Js
...
var.put('alias_22', PyJs_anonymous_38_)
@Js
...
var.put('alias_70', PyJs_anonymous_39_)
...
var.put('alias_77', PyJs_anonymous_40_)
@Js
...
var.put('alias_21', PyJs_anonymous_41_)
...
var.put('alias_74', PyJs_anonymous_42_)
@Js
...
var.put('alias_58', PyJs_anonymous_43_)
@Js
...
var.put('alias_30', PyJs_anonymous_44_)
@Js
...
var.put('alias_65', PyJs_anonymous_45_)
@Js
...
var.put('alias_31', PyJs_anonymous_46_)
@Js
...
var.put('alias_34', PyJs_anonymous_47_)
@Js
...
var.put('alias_9', PyJs_anonymous_48_)
@Js
...
var.put('alias_55', PyJs_anonymous_49_)
...
var.put('alias_62', PyJs_anonymous_50_)
@Js
...
var.put('alias_33', PyJs_anonymous_51_)
@Js
...
var.put('alias_29', PyJs_anonymous_52_)
@Js
...
var.put('alias_5', PyJs_anonymous_53_)
@Js
...
var.put('alias_25', PyJs_anonymous_54_)
@Js
...
var.put('alias_59', PyJs_anonymous_55_)
@Js
...
var.put('alias_39', PyJs_anonymous_56_)
...
var.put('alias_26', PyJs_anonymous_57_)
@Js
...
var.put('alias_19', PyJs_anonymous_58_)
...
var.put('alias_35', PyJs_anonymous_59_)
@Js
...
var.put('alias_68', PyJs_anonymous_61_)
@Js
...
var.put('alias_24', PyJs_anonymous_63_)
@Js
...
var.put('alias_27', PyJs_anonymous_64_)
@Js
def PyJs_anonymous_65_(d, this, arguments, var=var):
    var = Scope({'this':this, 'd':d, 'arguments':arguments}, var)
    var.registers(['d'])
    PyJs_Object_66_ = Js({'color':var.get('d').get('0')})
    return PyJs_Object_66_
PyJs_anonymous_65_._set_name('anonymous')
var.put('alias_52', PyJs_anonymous_65_)
@Js
...
var.put('alias_66', PyJs_anonymous_67_)
@Js
def PyJs_anonymous_68_(d, this, arguments, var=var):
    var = Scope({'this':this, 'd':d, 'arguments':arguments}, var)
    var.registers(['d'])
    PyJs_Object_69_ = Js({'characteristic':var.get('d').get('0').get('0')})
    return PyJs_Object_69_
PyJs_anonymous_68_._set_name('anonymous')
var.put('alias_18', PyJs_anonymous_68_)
@Js
...
var.put('alias_6', PyJs_anonymous_70_)
@Js
...
var.put('alias_57', PyJs_anonymous_71_)
@Js
...
var.put('alias_56', PyJs_anonymous_72_)
@Js
...
var.put('alias_73', PyJs_anonymous_73_)
@Js
...
var.put('alias_23', PyJs_anonymous_74_)
@Js
...
var.put('alias_2', PyJs_anonymous_75_)
@Js
...
var.put('alias_12', PyJs_anonymous_76_)
@Js
...
var.put('alias_69', PyJs_anonymous_77_)
