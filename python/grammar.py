...
# Code follows:
var.registers(['capacitance', 'nuller', 'toImperial', 'type', 'resistance', 'flat', 'flatten', 'filter', 'id'])
@Js
def PyJsHoisted_type_(t, this, arguments, var=var):
    ...
    def PyJs_anonymous_4_(d, this, arguments, var=var):
        var = Scope({'arguments':arguments, 'this':this, 'd':d}, var)
        var.registers(['d'])
...
def PyJsHoisted_capacitance_(d, this, arguments, var=var):
    var = Scope({'arguments':arguments, 'this':this, 'd':d}, var)
    var.registers(['metricPrefix', 'quantity', 'farad', 'd'])
...
def PyJsHoisted_flat_(arr, res, this, arguments, var=var):
    var = Scope({'arr':arr, 'this':this, 'arguments':arguments, 'res':res}, var)
    var.registers(['len', 'i', 'cur', 'arr', 'res'])
    var.put('i', Js(0.0))
...
def PyJsHoisted_resistance_(d, i, reject, this, arguments, var=var):
    var = Scope({'this':this, 'i':i, 'arguments':arguments, 'reject':reject, 'd':d}, var)
    var.registers(['quantity', 'reject', 'integral', 'ohm', 'd', 'metricPrefix', 'i', 'fractional'])
...
def PyJsHoisted_id_(x, this, arguments, var=var):
    var = Scope({'this':this, 'arguments':arguments, 'x':x}, var)
    var.registers(['x'])
...
var.put('alias_36', PyJs_anonymous_8_)
@Js
...
var.put('alias_29', PyJs_anonymous_9_)
@Js
...
var.put('alias_21', PyJs_anonymous_10_)
@Js
...
var.put('alias_3', PyJs_anonymous_11_)
@Js
...
var.put('alias_25', PyJs_anonymous_12_)
@Js
...
var.put('alias_11', PyJs_anonymous_13_)
@Js
def PyJs_anonymous_14_(d, this, arguments, var=var):
    var = Scope({'arguments':arguments, 'this':this, 'd':d}, var)
    var.registers(['d'])
    PyJs_Object_15_ = Js({'color':var.get('d').get('0')})
    return PyJs_Object_15_
PyJs_anonymous_14_._set_name('anonymous')
var.put('alias_52', PyJs_anonymous_14_)
@Js
...
var.put('alias_39', PyJs_anonymous_16_)
@Js
...
var.put('alias_9', PyJs_anonymous_17_)
@Js
...
var.put('alias_27', PyJs_anonymous_18_)
...
var.put('alias_72', PyJs_anonymous_24_)
@Js
...
var.put('alias_73', PyJs_anonymous_25_)
...
var.put('alias_70', PyJs_anonymous_26_)
@Js
...
var.put('alias_32', PyJs_anonymous_27_)
@Js
...
var.put('alias_26', PyJs_anonymous_28_)
@Js
def PyJs_anonymous_29_(d, this, arguments, var=var):
    var = Scope({'arguments':arguments, 'this':this, 'd':d}, var)
    var.registers(['d'])
    return var.get('toImperial').get(var.get('d').get('7'))
PyJs_anonymous_29_._set_name('anonymous')
var.put('alias_10', PyJs_anonymous_29_)
@Js
...
var.put('alias_24', PyJs_anonymous_31_)
@Js
...
var.put('alias_5', PyJs_anonymous_32_)
@Js
...
var.put('alias_55', PyJs_anonymous_33_)
@Js
...
var.put('alias_77', PyJs_anonymous_34_)
@Js
...
var.put('alias_12', PyJs_anonymous_35_)
@Js
...
var.put('alias_33', PyJs_anonymous_36_)
@Js
...
var.put('alias_65', PyJs_anonymous_38_)
@Js
...
var.put('alias_69', PyJs_anonymous_39_)
...
var.put('alias_40', PyJs_anonymous_40_)
@Js
...
var.put('alias_31', PyJs_anonymous_41_)
@Js
...
var.put('alias_20', PyJs_anonymous_42_)
@Js
...
var.put('alias_23', PyJs_anonymous_43_)
...
var.put('alias_63', PyJs_anonymous_44_)
@Js
...
var.put('alias_56', PyJs_anonymous_45_)
@Js
...
var.put('alias_59', PyJs_anonymous_46_)
@Js
...
var.put('alias_64', PyJs_anonymous_47_)
@Js
...
var.put('alias_35', PyJs_anonymous_50_)
...
var.put('alias_61', PyJs_anonymous_51_)
@Js
...
var.put('alias_2', PyJs_anonymous_52_)
@Js
...
var.put('alias_60', PyJs_anonymous_53_)
@Js
...
var.put('alias_74', PyJs_anonymous_54_)
@Js
...
var.put('alias_53', PyJs_anonymous_55_)
@Js
...
var.put('alias_34', PyJs_anonymous_57_)
@Js
...
var.put('alias_30', PyJs_anonymous_58_)
@Js
...
var.put('alias_76', PyJs_anonymous_59_)
@Js
...
var.put('alias_54', PyJs_anonymous_60_)
@Js
...
var.put('alias_38', PyJs_anonymous_61_)
@Js
...
var.put('alias_7', PyJs_anonymous_62_)
@Js
...
var.put('alias_22', PyJs_anonymous_63_)
@Js
def PyJs_anonymous_64_(d, this, arguments, var=var):
    var = Scope({'arguments':arguments, 'this':this, 'd':d}, var)
    var.registers(['d'])
    return (var.get('d').get('0')/Js(100.0))
PyJs_anonymous_64_._set_name('anonymous')
var.put('alias_4', PyJs_anonymous_64_)
@Js
def PyJs_anonymous_65_(d, this, arguments, var=var):
    var = Scope({'arguments':arguments, 'this':this, 'd':d}, var)
    var.registers(['metricPrefix', 'quantity', 'd'])
    var.put('quantity', var.get('d').get('0'))
    var.put('metricPrefix', var.get('d').get('2'))
...
var.put('alias_67', PyJs_anonymous_69_)
@Js
...
var.put('alias_68', PyJs_anonymous_70_)
@Js
...
var.put('alias_28', PyJs_anonymous_71_)
@Js
...
var.put('alias_41', PyJs_anonymous_72_)
@Js
...
var.put('alias_6', PyJs_anonymous_73_)
...
var.put('alias_62', PyJs_anonymous_74_)
@Js
def PyJs_anonymous_75_(d, this, arguments, var=var):
    var = Scope({'arguments':arguments, 'this':this, 'd':d}, var)
    var.registers(['d'])
    PyJs_Object_76_ = Js({'size':var.get('filter')(var.get('flatten')(var.get('d'))).callprop('join', Js(''))})
    return PyJs_Object_76_
PyJs_anonymous_75_._set_name('anonymous')
var.put('alias_8', PyJs_anonymous_75_)
@Js
...
var.put('alias_19', PyJs_anonymous_77_)
@Js
def PyJs_anonymous_78_(d, this, arguments, var=var):
    var = Scope({'arguments':arguments, 'this':this, 'd':d}, var)
    var.registers(['d'])
    PyJs_Object_79_ = Js({'tolerance':var.get('d').get('1')})
    return PyJs_Object_79_
PyJs_anonymous_78_._set_name('anonymous')
var.put('alias_42', PyJs_anonymous_78_)
pass
