...
# Code follows:
var.registers(['id', 'capacitance', 'type', '_flatten', 'toImperial', 'filter', 'flatten', 'resistance', 'nuller'])
@Js
def PyJsHoisted_capacitance_(d, this, arguments, var=var):
    var = Scope({'d':d, 'arguments':arguments, 'this':this}, var)
    var.registers(['farad', 'd', 'metricPrefix', 'quantity'])
...
def PyJsHoisted__flatten_(arr, res, this, arguments, var=var):
    var = Scope({'res':res, 'arguments':arguments, 'arr':arr, 'this':this}, var)
    var.registers(['len', 'i', 'res', 'arr', 'cur'])
    var.put('i', Js(0.0))
...
def PyJsHoisted_resistance_(d, i, reject, this, arguments, var=var):
    var = Scope({'d':d, 'i':i, 'reject':reject, 'arguments':arguments, 'this':this}, var)
    var.registers(['d', 'ohm', 'quantity', 'i', 'fractional', 'integral', 'metricPrefix', 'reject'])
...
var.put('alias_36', PyJs_anonymous_6_)
...
var.put('alias_28', PyJs_anonymous_7_)
@Js
...
var.put('alias_12', PyJs_anonymous_8_)
...
var.put('alias_11', PyJs_anonymous_9_)
@Js
...
var.put('alias_73', PyJs_anonymous_10_)
@Js
...
var.put('alias_45', PyJs_anonymous_11_)
@Js
...
var.put('alias_40', PyJs_anonymous_12_)
...
var.put('alias_34', PyJs_anonymous_13_)
...
var.put('alias_74', PyJs_anonymous_15_)
@Js
...
var.put('alias_59', PyJs_anonymous_16_)
@Js
def PyJs_anonymous_17_(d, this, arguments, var=var):
    var = Scope({'d':d, 'arguments':arguments, 'this':this}, var)
    var.registers(['d'])
    PyJs_Object_18_ = Js({'size':var.get('filter')(var.get('flatten')(var.get('d'))).callprop('join', Js(''))})
    return PyJs_Object_18_
PyJs_anonymous_17_._set_name('anonymous')
var.put('alias_8', PyJs_anonymous_17_)
@Js
...
var.put('alias_4', PyJs_anonymous_19_)
@Js
...
var.put('alias_25', PyJs_anonymous_20_)
@Js
...
var.put('alias_42', PyJs_anonymous_21_)
@Js
...
var.put('alias_78', PyJs_anonymous_22_)
@Js
...
var.put('alias_3', PyJs_anonymous_23_)
@Js
...
var.put('alias_30', PyJs_anonymous_24_)
@Js
...
var.put('alias_33', PyJs_anonymous_25_)
@Js
...
var.put('alias_69', PyJs_anonymous_26_)
@Js
...
var.put('alias_63', PyJs_anonymous_27_)
@Js
...
var.put('alias_80', PyJs_anonymous_28_)
...
var.put('alias_27', PyJs_anonymous_29_)
@Js
def PyJs_anonymous_30_(d, this, arguments, var=var):
    var = Scope({'d':d, 'arguments':arguments, 'this':this}, var)
    var.registers(['d'])
    PyJs_Object_31_ = Js({'voltage_rating':var.get('d').get('0')})
    return PyJs_Object_31_
PyJs_anonymous_30_._set_name('anonymous')
var.put('alias_18', PyJs_anonymous_30_)
@Js
...
var.put('alias_70', PyJs_anonymous_32_)
...
var.put('alias_31', PyJs_anonymous_33_)
@Js
...
var.put('alias_60', PyJs_anonymous_34_)
@Js
...
var.put('alias_65', PyJs_anonymous_35_)
@Js
...
var.put('alias_79', PyJs_anonymous_36_)
@Js
...
var.put('alias_62', PyJs_anonymous_37_)
@Js
...
var.put('alias_67', PyJs_anonymous_38_)
@Js
...
var.put('alias_72', PyJs_anonymous_39_)
@Js
...
var.put('alias_81', PyJs_anonymous_40_)
@Js
def PyJs_anonymous_41_(d, this, arguments, var=var):
    var = Scope({'d':d, 'arguments':arguments, 'this':this}, var)
    var.registers(['d'])
    PyJs_Object_42_ = Js({'tolerance':var.get('d').get('1')})
    return PyJs_Object_42_
PyJs_anonymous_41_._set_name('anonymous')
var.put('alias_47', PyJs_anonymous_41_)
@Js
...
var.put('alias_68', PyJs_anonymous_43_)
@Js
def PyJs_anonymous_44_(d, this, arguments, var=var):
    var = Scope({'d':d, 'arguments':arguments, 'this':this}, var)
    var.registers(['d'])
    PyJs_Object_45_ = Js({'color':var.get('d').get('0')})
    return PyJs_Object_45_
PyJs_anonymous_44_._set_name('anonymous')
var.put('alias_57', PyJs_anonymous_44_)
@Js
def PyJs_anonymous_46_(d, this, arguments, var=var):
    var = Scope({'d':d, 'arguments':arguments, 'this':this}, var)
    var.registers(['d'])
    if var.get('d').get('0'):
...
var.put('alias_1', PyJs_anonymous_46_)
@Js
...
var.put('alias_5', PyJs_anonymous_47_)
@Js
...
var.put('alias_64', PyJs_anonymous_48_)
@Js
...
var.put('alias_26', PyJs_anonymous_49_)
@Js
def PyJs_anonymous_50_(d, this, arguments, var=var):
    var = Scope({'d':d, 'arguments':arguments, 'this':this}, var)
    var.registers(['d'])
    PyJs_Object_51_ = Js({'characteristic':var.get('d').get('0').get('0')})
    return PyJs_Object_51_
PyJs_anonymous_50_._set_name('anonymous')
var.put('alias_19', PyJs_anonymous_50_)
...
var.put('alias_76', PyJs_anonymous_52_)
@Js
...
var.put('alias_58', PyJs_anonymous_53_)
...
var.put('alias_32', PyJs_anonymous_54_)
...
var.put('alias_0', PyJs_anonymous_55_)
...
var.put('alias_66', PyJs_anonymous_56_)
...
var.put('alias_38', PyJs_anonymous_57_)
@Js
...
var.put('alias_75', PyJs_anonymous_58_)
@Js
def PyJs_anonymous_59_(d, this, arguments, var=var):
    var = Scope({'d':d, 'arguments':arguments, 'this':this}, var)
    var.registers(['d'])
    return var.get('toImperial').get(var.get('d').get('0'))
PyJs_anonymous_59_._set_name('anonymous')
var.put('alias_9', PyJs_anonymous_59_)
@Js
...
var.put('alias_61', PyJs_anonymous_60_)
@Js
...
var.put('alias_82', PyJs_anonymous_61_)
@Js
...
var.put('alias_29', PyJs_anonymous_62_)
var.put('alias_55', var.get('nuller'))
@Js
def PyJs_anonymous_63_(d, this, arguments, var=var):
    var = Scope({'d':d, 'arguments':arguments, 'this':this}, var)
    var.registers(['d', 'metricPrefix', 'quantity'])
    var.put('quantity', var.get('d').get('0'))
    var.put('metricPrefix', var.get('d').get('2'))
    PyJs_Object_64_ = Js({'power_rating':var.get('parseFloat')((var.get('quantity')+(var.get('metricPrefix') or Js(''))))})
    return PyJs_Object_64_
PyJs_anonymous_63_._set_name('anonymous')
var.put('alias_52', PyJs_anonymous_63_)
@Js
...
var.put('alias_41', PyJs_anonymous_65_)
@Js
def PyJs_anonymous_66_(d, this, arguments, var=var):
    var = Scope({'d':d, 'arguments':arguments, 'this':this}, var)
    var.registers(['d'])
    return var.get('d').callprop('join', Js('')).callprop('toUpperCase')
PyJs_anonymous_66_._set_name('anonymous')
var.put('alias_46', PyJs_anonymous_66_)
@Js
...
var.put('alias_37', PyJs_anonymous_67_)
@Js
...
var.put('alias_71', PyJs_anonymous_68_)
@Js
...
var.put('alias_35', PyJs_anonymous_69_)
@Js
...
var.put('alias_44', PyJs_anonymous_70_)
...
var.put('alias_77', PyJs_anonymous_71_)
@Js
...
var.put('alias_10', PyJs_anonymous_72_)
@Js
...
var.put('alias_24', PyJs_anonymous_73_)
@Js
...
var.put('alias_2', PyJs_anonymous_74_)
...
var.put('alias_39', PyJs_anonymous_75_)
pass
