...
(function () {
    ...
    var grammar = {
        ...
        ParserRules: [{ "name": "unsigned_int$ebnf$1", "symbols": [/[0-9]/] }, { "name": "unsigned_int$ebnf$1", "symbols": ["unsigned_int$ebnf$1", /[0-9]/], "postprocess": function arrpush(d) {
            ...
            } }, { "name": "_characteristic$string$1", "symbols": [{ "literal": "X" }, { "literal": "7" }, { "literal": "R" }], "postprocess": function joiner(d) {
                return d.join('');
            } }, { "name": "_characteristic", "symbols": ["_characteristic$string$1"] }, { "name": "tolerance$ebnf$1$subexpression$1", "symbols": ["plusMinus", "_"] }, { "name": "tolerance$ebnf$1", "symbols": ["tolerance$ebnf$1$subexpression$1"], "postprocess": id }, { "name": "tolerance$ebnf$1", "symbols": [], "postprocess": function postprocess(d) {
                return null;
