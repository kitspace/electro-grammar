...
(function () {
    ...
    var grammar = {
        ...
        ParserRules: [{ "name": "unsigned_int$ebnf$1", "symbols": [/[0-9]/] }, { "name": "unsigned_int$ebnf$1", "symbols": ["unsigned_int$ebnf$1", /[0-9]/], "postprocess": function arrpush(d) {
                ...
                return d.join('');
            } }, { "name": "deca", "symbols": ["deca$string$1"] }, { "name": "deca", "symbols": ["D", "E", "C", "A"] }, { "name": "deci", "symbols": [{ "literal": "d" }] }, { "name": "deci", "symbols": ["D", "E", "C", "I"] }, { "name": "centi", "symbols": [{ "literal": "c" }] }, { "name": "centi", "symbols": ["C", "E", "N", "T", "I"] }, { "name": "milli", "symbols": [{ "literal": "m" }] }, { "name": "milli", "symbols": ["M", "I", "L", "L", "I"] }, { "name": "micro", "symbols": [{ "literal": "u" }] }, { "name": "micro", "symbols": [/[\u03BC]/] }, { "name": "micro", "symbols": [/[\u00B5]/] }, { "name": "micro", "symbols": [/[\uD835]/, /[\uDECD]/] }, { "name": "micro", "symbols": [/[\uD835]/, /[\uDF07]/] }, { "name": "micro", "symbols": [/[\uD835]/, /[\uDF41]/] }, { "name": "micro", "symbols": [/[\uD835]/, /[\uDF7B]/] }, { "name": "micro", "symbols": [/[\uD835]/, /[\uDFB5]/] }, { "name": "micro", "symbols": ["M", "I", "C", "R", "O"] }, { "name": "nano", "symbols": [{ "literal": "n" }] }, { "name": "nano", "symbols": ["N", "A", "N", "O"] }, { "name": "pico", "symbols": [{ "literal": "p" }] }, { "name": "pico", "symbols": ["P", "I", "C", "O"] }, { "name": "femto", "symbols": [{ "literal": "f" }] }, { "name": "femto", "symbols": ["F", "E", "M", "T", "O"] }, { "name": "atto", "symbols": [{ "literal": "a" }] }, { "name": "atto", "symbols": ["A", "T", "T", "O"] }, { "name": "package_size", "symbols": ["_package_size"], "postprocess": function postprocess(d) {
            ...
            } }, { "name": "capacitor", "symbols": ["cSpecs", "capacitance", "cSpecs", "package_size", "cSpecs"] }, { "name": "capacitor", "symbols": ["cSpecs", "package_size", "cSpecs", "capacitance", "cSpecs"] }, { "name": "cSpecs$ebnf$1", "symbols": [] }, { "name": "cSpecs$ebnf$1$subexpression$1", "symbols": ["_", "cSpec", "_"] }, { "name": "cSpecs$ebnf$1", "symbols": ["cSpecs$ebnf$1", "cSpecs$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {
                return d[0].concat([d[1]]);
            } }, { "name": "cSpecs", "symbols": ["cSpecs$ebnf$1"] }, { "name": "cSpecs", "symbols": ["__"] }, { "name": "cSpec$ebnf$1$subexpression$1", "symbols": ["plus_minus", "_"] }, { "name": "cSpec$ebnf$1", "symbols": ["cSpec$ebnf$1$subexpression$1"], "postprocess": id }, { "name": "cSpec$ebnf$1", "symbols": [], "postprocess": function postprocess(d) {
                return null;
                ...
                return d.join('');
            } }, { "name": "plus_minus", "symbols": ["plus_minus$string$1"] }, { "name": "plus_minus", "symbols": [{ "literal": "±" }] }, { "name": "plus_minus$string$2", "symbols": [{ "literal": "+" }, { "literal": "-" }], "postprocess": function joiner(d) {
                return d.join('');
            } }, { "name": "plus_minus", "symbols": ["plus_minus$string$2"] }, { "name": "capacitance", "symbols": ["decimal", "_", "metric_prefix", "_", "farad"], "postprocess": capacitance }, { "name": "farad", "symbols": [{ "literal": "F" }], "postprocess": function postprocess() {
                return null;
