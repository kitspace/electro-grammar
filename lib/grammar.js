...
(function () {
    ...
    var grammar = {
        ...
        ParserRules: [{ "name": "unsigned_int$ebnf$1", "symbols": [/[0-9]/] }, { "name": "unsigned_int$ebnf$1", "symbols": ["unsigned_int$ebnf$1", /[0-9]/], "postprocess": function arrpush(d) {
            ...
            } }, { "name": "main_", "symbols": ["component"] }, { "name": "component", "symbols": ["capacitor"], "postprocess": type('capacitor') }, { "name": "component", "symbols": ["resistor"], "postprocess": type('resistor') }, { "name": "component", "symbols": ["led"], "postprocess": type('led') }, { "name": "component", "symbols": ["packageSize"], "postprocess": type('unknown') }, { "name": "component", "symbols": ["tolerance"], "postprocess": type('unknown') }, { "name": "component", "symbols": ["voltage_rating"], "postprocess": type('unknown') }, { "name": "component", "symbols": ["cap_"], "postprocess": type('capacitor') }, { "name": "component", "symbols": ["res_"], "postprocess": type('resistor') }, { "name": "capacitor", "symbols": ["cSpecs", "capacitance", "cSpecs"] }, { "name": "capacitor$subexpression$1", "symbols": ["capacitanceNoFarad"] }, { "name": "capacitor$subexpression$1", "symbols": ["capacitance"] }, { "name": "capacitor", "symbols": ["cap", "cSpecs", "capacitor$subexpression$1", "cSpecs"] }, { "name": "cap", "symbols": ["cap_", "__"], "postprocess": nuller }, { "name": "cap_$subexpression$1", "symbols": [/[cC]/], "postprocess": function postprocess(d) {
                return d.join("");
            } }, { "name": "cap_", "symbols": ["cap_$subexpression$1"] }, { "name": "cap_$subexpression$2", "symbols": [/[cC]/, /[aA]/, /[pP]/], "postprocess": function postprocess(d) {
                return d.join("");
            } }, { "name": "cap_", "symbols": ["cap_$subexpression$2"] }, { "name": "cap_$subexpression$3", "symbols": [/[cC]/, /[aA]/, /[pP]/, /[aA]/, /[cC]/, /[iI]/, /[tT]/, /[oO]/, /[rR]/], "postprocess": function postprocess(d) {
                return d.join("");
            } }, { "name": "cap_", "symbols": ["cap_$subexpression$3"] }, { "name": "cSpecs$ebnf$1", "symbols": [] }, { "name": "cSpecs$ebnf$1$subexpression$1", "symbols": ["_", "cSpec", "_"] }, { "name": "cSpecs$ebnf$1", "symbols": ["cSpecs$ebnf$1", "cSpecs$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {
                return d[0].concat([d[1]]);
                ...
                return null;
            } }, { "name": "capacitanceNoFarad", "symbols": ["decimal", "_", "capacitanceNoFarad$ebnf$1"], "postprocess": capacitance }, { "name": "farad", "symbols": ["F"], "postprocess": nuller }, { "name": "farad", "symbols": ["F", "A", "R", "A", "D"], "postprocess": nuller }, { "name": "resistor$ebnf$1", "symbols": ["res"], "postprocess": id }, { "name": "resistor$ebnf$1", "symbols": [], "postprocess": function postprocess(d) {
                return null;
            } }, { "name": "resistor", "symbols": ["resistor$ebnf$1", "rSpecs", "resistance", "rSpecs"] }, { "name": "res", "symbols": ["res_", "__"], "postprocess": nuller }, { "name": "res_$subexpression$1", "symbols": [/[rR]/], "postprocess": function postprocess(d) {
                return d.join("");
            } }, { "name": "res_", "symbols": ["res_$subexpression$1"] }, { "name": "res_$subexpression$2", "symbols": [/[rR]/, /[eE]/, /[sS]/], "postprocess": function postprocess(d) {
                return d.join("");
            } }, { "name": "res_", "symbols": ["res_$subexpression$2"] }, { "name": "res_$subexpression$3", "symbols": [/[rR]/, /[eE]/, /[sS]/, /[iI]/, /[sS]/, /[tT]/, /[oO]/, /[rR]/], "postprocess": function postprocess(d) {
                return d.join("");
            } }, { "name": "res_", "symbols": ["res_$subexpression$3"] }, { "name": "rSpecs$ebnf$1", "symbols": [] }, { "name": "rSpecs$ebnf$1$subexpression$1", "symbols": ["_", "rSpec", "_"] }, { "name": "rSpecs$ebnf$1", "symbols": ["rSpecs$ebnf$1", "rSpecs$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {
                return d[0].concat([d[1]]);
