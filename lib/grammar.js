...
(function () {
    ...
    var grammar = {
        ...
        ParserRules: [{ "name": "unsigned_int$ebnf$1", "symbols": [/[0-9]/] }, { "name": "unsigned_int$ebnf$1", "symbols": ["unsigned_int$ebnf$1", /[0-9]/], "postprocess": function arrpush(d) {
                ...
                return null;
            } }, { "name": "capacitor", "symbols": ["cap", "cSpecs", "capacitor$ebnf$3", "cSpecs", "capacitanceNoFarad", "cSpecs"] }, { "name": "capacitor$ebnf$4", "symbols": ["packageSize"], "postprocess": id }, { "name": "capacitor$ebnf$4", "symbols": [], "postprocess": function postprocess(d) {
                return null;
            } }, { "name": "capacitor", "symbols": ["cap", "cSpecs", "capacitanceNoFarad", "cSpecs", "capacitor$ebnf$4", "cSpecs"] }, { "name": "cap$ebnf$1", "symbols": ["A"], "postprocess": id }, { "name": "cap$ebnf$1", "symbols": [], "postprocess": function postprocess(d) {
                return null;
                ...
                return null;
            } }, { "name": "resistance", "symbols": ["decimal", "rMetricPrefix", "resistance$ebnf$1", "resistance$ebnf$2"], "postprocess": resistance }, { "name": "ohm", "symbols": ["O", "H", "M"], "postprocess": function postprocess() {
                return null;
                ...
                return 'e3  ';
            } }, { "name": "rMetricPrefix", "symbols": [], "postprocess": function postprocess() {
                return '';
