...
(function () {
  ...
  var grammar = {
    ...
    ParserRules: [{ "name": "unsigned_int$ebnf$1", "symbols": [/[0-9]/] }, { "name": "unsigned_int$ebnf$1", "symbols": ["unsigned_int$ebnf$1", /[0-9]/], "postprocess": function arrpush(d) {
        ...
        return null;
      } }, { "name": "capacitor$ebnf$4$subexpression$1", "symbols": ["capacitanceNoFarad"] }, { "name": "capacitor$ebnf$4$subexpression$1", "symbols": ["capacitance"] }, { "name": "capacitor$ebnf$4", "symbols": ["capacitor$ebnf$4$subexpression$1"], "postprocess": id }, { "name": "capacitor$ebnf$4", "symbols": [], "postprocess": function postprocess(d) {
        return null;
      } }, { "name": "capacitor", "symbols": ["cap", "cSpecs", "capacitor$ebnf$3", "cSpecs", "capacitor$ebnf$4", "cSpecs"] }, { "name": "capacitor$ebnf$5$subexpression$1", "symbols": ["capacitanceNoFarad"] }, { "name": "capacitor$ebnf$5$subexpression$1", "symbols": ["capacitance"] }, { "name": "capacitor$ebnf$5", "symbols": ["capacitor$ebnf$5$subexpression$1"], "postprocess": id }, { "name": "capacitor$ebnf$5", "symbols": [], "postprocess": function postprocess(d) {
        return null;
      } }, { "name": "capacitor$ebnf$6", "symbols": ["packageSize"], "postprocess": id }, { "name": "capacitor$ebnf$6", "symbols": [], "postprocess": function postprocess(d) {
        return null;
      } }, { "name": "capacitor", "symbols": ["cap", "cSpecs", "capacitor$ebnf$5", "cSpecs", "capacitor$ebnf$6", "cSpecs"] }, { "name": "cap$ebnf$1", "symbols": ["A"], "postprocess": id }, { "name": "cap$ebnf$1", "symbols": [], "postprocess": function postprocess(d) {
        return null;
        ...
        return null;
      } }, { "name": "resistor", "symbols": ["resistor$ebnf$3", "rSpecs", "resistor$ebnf$4", "rSpecs", "resistance", "rSpecs"] }, { "name": "resistor$ebnf$5", "symbols": ["resistanceNoR"], "postprocess": id }, { "name": "resistor$ebnf$5", "symbols": [], "postprocess": function postprocess(d) {
        return null;
      } }, { "name": "resistor$ebnf$6", "symbols": ["packageSize"], "postprocess": id }, { "name": "resistor$ebnf$6", "symbols": [], "postprocess": function postprocess(d) {
        return null;
      } }, { "name": "resistor", "symbols": ["resistor_prefix", "rSpecs", "resistor$ebnf$5", "rSpecs", "resistor$ebnf$6", "rSpecs"] }, { "name": "resistor$ebnf$7", "symbols": ["packageSize"], "postprocess": id }, { "name": "resistor$ebnf$7", "symbols": [], "postprocess": function postprocess(d) {
        return null;
      } }, { "name": "resistor$ebnf$8", "symbols": ["resistanceNoR"], "postprocess": id }, { "name": "resistor$ebnf$8", "symbols": [], "postprocess": function postprocess(d) {
        return null;
      } }, { "name": "resistor", "symbols": ["resistor_prefix", "rSpecs", "resistor$ebnf$7", "rSpecs", "resistor$ebnf$8", "rSpecs"] }, { "name": "resistor_prefix", "symbols": ["R"], "postprocess": nuller }, { "name": "resistor_prefix", "symbols": ["R", "E", "S"], "postprocess": nuller }, { "name": "resistor_prefix", "symbols": ["R", "E", "S", "I", "S", "T", "O", "R"], "postprocess": nuller }, { "name": "rSpecs$ebnf$1", "symbols": [] }, { "name": "rSpecs$ebnf$1$subexpression$1", "symbols": ["_", "rSpec", "_"] }, { "name": "rSpecs$ebnf$1", "symbols": ["rSpecs$ebnf$1", "rSpecs$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {
        return d[0].concat([d[1]]);
