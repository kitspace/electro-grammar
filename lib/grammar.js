...
(function () {
    ...
    var grammar = {
        ...
        ParserRules: [{ "name": "unsigned_int$ebnf$1", "symbols": [/[0-9]/] }, { "name": "unsigned_int$ebnf$1", "symbols": ["unsigned_int$ebnf$1", /[0-9]/], "postprocess": function arrpush(d) {
                ...
                return 10e2;
            } }, { "name": "metricPrefix", "symbols": ["deca"], "postprocess": function postprocess() {
                return 10;
                ...
                return { tolerance: d[1] };
            } }, { "name": "resistance$ebnf$1$subexpression$1", "symbols": ["_", "ohm"] }, { "name": "resistance$ebnf$1", "symbols": ["resistance$ebnf$1$subexpression$1"], "postprocess": id }, { "name": "resistance$ebnf$1", "symbols": [], "postprocess": function postprocess(d) {
                return null;
            } }, { "name": "resistance", "symbols": ["decimal", "_", "metricPrefix", "resistance$ebnf$1"], "postprocess": resistance }, { "name": "ohm", "symbols": ["O", "H", "M"], "postprocess": function postprocess() {
                return null;
            } }],
        ParserStart: "main"
    };
