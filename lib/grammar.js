...
(function () {
    ...
    var grammar = {
        ...
        ParserRules: [{ "name": "unsigned_int$ebnf$1", "symbols": [/[0-9]/] }, { "name": "unsigned_int$ebnf$1", "symbols": ["unsigned_int$ebnf$1", /[0-9]/], "postprocess": function arrpush(d) {
                ...
                return null;
            } }, { "name": "capacitor", "symbols": ["cSpecs", "capacitor$ebnf$2", "cSpecs", "capacitance", "cSpecs"] }, { "name": "cSpecs$ebnf$1", "symbols": [] }, { "name": "cSpecs$ebnf$1$subexpression$1", "symbols": ["_", "cSpec", "_"] }, { "name": "cSpecs$ebnf$1", "symbols": ["cSpecs$ebnf$1", "cSpecs$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {
                return d[0].concat([d[1]]);
            } }, { "name": "cSpecs", "symbols": ["cSpecs$ebnf$1"] }, { "name": "cSpecs", "symbols": ["__"] }, { "name": "cSpec", "symbols": ["tolerance"] }, { "name": "cSpec", "symbols": ["characteristic"] }, { "name": "characteristic", "symbols": ["_characteristic"], "postprocess": function postprocess(d) {
                ...
                return "X5R";
            } }, { "name": "_characteristic", "symbols": ["C", { "literal": "0" }, "G"], "postprocess": function postprocess(d) {
                return "C0G/NP0";
            } }, { "name": "_characteristic", "symbols": ["N", "P", { "literal": "0" }], "postprocess": function postprocess(d) {
                return "C0G/NP0";
            } }, { "name": "_characteristic", "symbols": ["C", { "literal": "0" }, "G", { "literal": "/" }, "N", "P", { "literal": "0" }], "postprocess": function postprocess(d) {
                return "C0G/NP0";
                ...
                return d[0].concat([d[1]]);
            } }, { "name": "rSpecs", "symbols": ["rSpecs$ebnf$1"] }, { "name": "rSpecs", "symbols": ["__"] }, { "name": "rSpec", "symbols": ["tolerance"] }, { "name": "resistance$ebnf$1", "symbols": ["int"], "postprocess": id }, { "name": "resistance$ebnf$1", "symbols": [], "postprocess": function postprocess(d) {
                return null;
