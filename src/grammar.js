...
var grammar = {
    ...
    {"name": "_characteristic$string$1", "symbols": [{"literal":"X"}, {"literal":"7"}, {"literal":"R"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "_characteristic", "symbols": ["_characteristic$string$1"]},
