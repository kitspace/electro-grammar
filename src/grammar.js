...
var grammar = {
    ...
    {"name": "main", "symbols": ["_", "main_", "_"], "postprocess": function(d) { return filter(flatten(d)) }},
    {"name": "main_", "symbols": ["component"]},
    ...
    {"name": "component", "symbols": ["packageSize"], "postprocess": type('unknown')},
    {"name": "component", "symbols": ["tolerance"], "postprocess": type('unknown')},
    {"name": "component", "symbols": ["voltage_rating"], "postprocess": type('unknown')},
    {"name": "component", "symbols": ["cap_"], "postprocess": type('capacitor')},
    {"name": "component", "symbols": ["res_"], "postprocess": type('resistor')},
    ...
    {"name": "cap", "symbols": ["cap_", "__"], "postprocess": nuller},
    {"name": "cap_$subexpression$1", "symbols": [/[cC]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "cap_", "symbols": ["cap_$subexpression$1"]},
    {"name": "cap_$subexpression$2", "symbols": [/[cC]/, /[aA]/, /[pP]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "cap_", "symbols": ["cap_$subexpression$2"]},
    {"name": "cap_$subexpression$3", "symbols": [/[cC]/, /[aA]/, /[pP]/, /[aA]/, /[cC]/, /[iI]/, /[tT]/, /[oO]/, /[rR]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "cap_", "symbols": ["cap_$subexpression$3"]},
    ...
    {"name": "resistor$ebnf$1", "symbols": ["res"], "postprocess": id},
    {"name": "resistor$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "resistor", "symbols": ["resistor$ebnf$1", "rSpecs", "resistance", "rSpecs"]},
    {"name": "res", "symbols": ["res_", "__"], "postprocess": nuller},
    {"name": "res_$subexpression$1", "symbols": [/[rR]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "res_", "symbols": ["res_$subexpression$1"]},
    {"name": "res_$subexpression$2", "symbols": [/[rR]/, /[eE]/, /[sS]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "res_", "symbols": ["res_$subexpression$2"]},
    {"name": "res_$subexpression$3", "symbols": [/[rR]/, /[eE]/, /[sS]/, /[iI]/, /[sS]/, /[tT]/, /[oO]/, /[rR]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "res_", "symbols": ["res_$subexpression$3"]},
