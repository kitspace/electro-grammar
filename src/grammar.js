...
var grammar = {
    ...
    {"name": "packageSize$ebnf$1", "symbols": ["_ignoredPackagePrefix"], "postprocess": id},
    {"name": "packageSize$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "packageSize", "symbols": ["packageSize$ebnf$1", "_packageSize"], "postprocess": d => ({size: filter(flatten(d))[0]})},
    ...
    {"name": "D", "symbols": [{"literal":"D"}]},
    {"name": "D", "symbols": [{"literal":"d"}]},
    {"name": "_ignoredPackagePrefix", "symbols": ["R"], "postprocess": nuller},
    {"name": "_ignoredPackagePrefix", "symbols": ["C"], "postprocess": nuller},
    {"name": "_ignoredPackagePrefix", "symbols": ["L", "E", "D"], "postprocess": nuller},
    ...
    {"name": "class1$macrocall$5", "symbols": ["C", "O", "G"]},
    {"name": "class1$macrocall$6", "symbols": ["N", "P", "O"]},
    ...
    {"name": "class1", "symbols": ["class1$macrocall$4"], "postprocess": () => 'C0G'},
    {"name": "class1$macrocall$8$string$1", "symbols": [{"literal":"1"}, {"literal":"0"}, {"literal":"0"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "class1$macrocall$8", "symbols": ["P", "class1$macrocall$8$string$1"]},
    {"name": "class1$macrocall$9", "symbols": ["M", {"literal":"7"}, "G"]},
    ...
    {"name": "class1", "symbols": ["class1$macrocall$7"], "postprocess": () => 'M7G'},
    {"name": "class1$macrocall$11$string$1", "symbols": [{"literal":"3"}, {"literal":"3"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "class1$macrocall$11", "symbols": ["N", "class1$macrocall$11$string$1"]},
    {"name": "class1$macrocall$12", "symbols": ["H", {"literal":"2"}, "G"]},
    ...
    {"name": "class1", "symbols": ["class1$macrocall$10"], "postprocess": () => 'H2G'},
    {"name": "class1$macrocall$14$string$1", "symbols": [{"literal":"7"}, {"literal":"5"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "class1$macrocall$14", "symbols": ["N", "class1$macrocall$14$string$1"]},
    {"name": "class1$macrocall$15", "symbols": ["L", {"literal":"2"}, "G"]},
    ...
    {"name": "class1", "symbols": ["class1$macrocall$13"], "postprocess": () => 'L2G'},
    {"name": "class1$macrocall$17$string$1", "symbols": [{"literal":"1"}, {"literal":"5"}, {"literal":"0"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "class1$macrocall$17", "symbols": ["N", "class1$macrocall$17$string$1"]},
    {"name": "class1$macrocall$18", "symbols": ["P", {"literal":"2"}, "H"]},
    ...
    {"name": "class1", "symbols": ["class1$macrocall$16"], "postprocess": () => 'P2H'},
    {"name": "class1$macrocall$20$string$1", "symbols": [{"literal":"2"}, {"literal":"2"}, {"literal":"0"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "class1$macrocall$20", "symbols": ["N", "class1$macrocall$20$string$1"]},
    {"name": "class1$macrocall$21", "symbols": ["R", {"literal":"2"}, "H"]},
    ...
    {"name": "class1", "symbols": ["class1$macrocall$19"], "postprocess": () => 'R2H'},
    {"name": "class1$macrocall$23$string$1", "symbols": [{"literal":"3"}, {"literal":"3"}, {"literal":"0"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "class1$macrocall$23", "symbols": ["N", "class1$macrocall$23$string$1"]},
    {"name": "class1$macrocall$24", "symbols": ["S", {"literal":"2"}, "H"]},
    ...
    {"name": "class1", "symbols": ["class1$macrocall$22"], "postprocess": () => 'S2H'},
    {"name": "class1$macrocall$26$string$1", "symbols": [{"literal":"4"}, {"literal":"7"}, {"literal":"0"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "class1$macrocall$26", "symbols": ["N", "class1$macrocall$26$string$1"]},
    {"name": "class1$macrocall$27", "symbols": ["T", {"literal":"2"}, "H"]},
    ...
    {"name": "class1", "symbols": ["class1$macrocall$25"], "postprocess": () => 'T2H'},
    {"name": "class1$macrocall$29$string$1", "symbols": [{"literal":"7"}, {"literal":"5"}, {"literal":"0"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "class1$macrocall$29", "symbols": ["N", "class1$macrocall$29$string$1"]},
    {"name": "class1$macrocall$30", "symbols": ["U", {"literal":"2"}, "J"]},
    ...
    {"name": "class1", "symbols": ["class1$macrocall$28"], "postprocess": () => 'U2J'},
    {"name": "class1$macrocall$32$string$1", "symbols": [{"literal":"1"}, {"literal":"0"}, {"literal":"0"}, {"literal":"0"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "class1$macrocall$32", "symbols": ["N", "class1$macrocall$32$string$1"]},
    {"name": "class1$macrocall$33", "symbols": ["Q", {"literal":"3"}, "K"]},
    ...
    {"name": "class1", "symbols": ["class1$macrocall$31"], "postprocess": () => 'Q3K'},
    {"name": "class1$macrocall$35$string$1", "symbols": [{"literal":"1"}, {"literal":"5"}, {"literal":"0"}, {"literal":"0"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "class1$macrocall$35", "symbols": ["N", "class1$macrocall$35$string$1"]},
    {"name": "class1$macrocall$36", "symbols": ["P", {"literal":"3"}, "K"]},
    {"name": "class1$macrocall$34", "symbols": ["class1$macrocall$35"]},
    {"name": "class1$macrocall$34", "symbols": ["class1$macrocall$36"]},
    {"name": "class1$macrocall$34", "symbols": ["class1$macrocall$35", {"literal":"/"}, "class1$macrocall$36"]},
    {"name": "class1$macrocall$34", "symbols": ["class1$macrocall$36", {"literal":"/"}, "class1$macrocall$35"]},
    {"name": "class1", "symbols": ["class1$macrocall$34"], "postprocess": () => 'P3K'},
    ...
    {"name": "resistor$ebnf$1", "symbols": ["resistor_prefix"], "postprocess": id},
    ...
    {"name": "resistor", "symbols": ["resistor$ebnf$1", "rSpecs", "resistance", "rSpecs", "resistor$ebnf$2", "rSpecs"]},
    {"name": "resistor$ebnf$3", "symbols": ["resistor_prefix"], "postprocess": id},
    {"name": "resistor$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    ...
    {"name": "resistanceNoR", "symbols": ["decimal"], "postprocess": d => ({resistance: d[0]})},
