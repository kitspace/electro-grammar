...
describe('SMD Capacitors', () => {
    ...
    it('ignores extra words 3', () => {
        const {
            component: c,
            ignored,
        } = parse('capacitor 100nF 0603, warehouse 5', { returnIgnored: true })
    ...
    it('ignores extra words 4', () => {
        const {
            component: c,
            ignored,
        } = parse('adjalkjd 0603 akjdlkjda 100nF kajdlkja alkdjlkajd', {
            returnIgnored: true,
        })
    ...
    it('ignores extra words 5', () => {
        const {
            component: c,
            ignored,
        } = parse('capacitor 100nF 0603, warehouse 5 %', {
            returnIgnored: true,
        })
    ...
    it('ignores extra words 7', () => {
        const {
            component: c,
            ignored,
        } = parse('x5527 100nF 0603, warehouse 5%', { returnIgnored: true })
    ...
    it('ignores extra words 8', () => {
        const {
            component: c,
            ignored,
        } = parse('5527 x 100nF 0603, warehouse 5%', { returnIgnored: true })
    ...
    it('ignores extra words 10', () => {
        const {
            component: c,
            ignored,
        } = parse('adjalkjd 0603 50001 100nF akjdlkjda kajdlkja alkdjlkajd', {
            returnIgnored: true,
        })
